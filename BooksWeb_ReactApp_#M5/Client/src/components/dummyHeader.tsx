...
export default function DummyHeader({}: Props): ReactElement {
  ...
  return (
    <>
      <ul className="navbar-nav mybar" style={{display:"inline-block"}}>
              <li className="nav-item-new active" style={{display:"inline-block"}}>
