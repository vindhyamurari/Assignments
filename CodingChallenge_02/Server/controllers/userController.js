...
function emailInUse(email, response) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, usersSchema_1.users.findOne({ email: email })];
                case 1:
...
function registerUser(request, response) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, email_1, password_1, err_2;
        var _this = this;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 5, , 6]);
                    _a = request.body, email_1 = _a.email, password_1 = _a.password;
                    return [4 /*yield*/, emailInUse(email_1, response)];
                case 1:
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        password_1 = hash;
                                        newUser = new usersSchema_1.users();
                                        newUser = { email: email_1, password: password_1 };
                                        return [4 /*yield*/, usersSchema_1.users.create(newUser)];
                                    case 1:
                                        newUser = _a.sent();
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, emailInUse(email, response)];
                case 1:
                    userEmail = _b.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, usersSchema_1.users.findById(decode.userId)];
                case 1:
