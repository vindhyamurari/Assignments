...
exports.deleteBook = exports.updateBook = exports.postBook = exports.getBooksLessThanGivenRating = exports.getBookById = exports.getBooksInPriceRange = exports.getBookByTitle = exports.getBooksByAuthor = exports.getBooksBySearchOnSimpleText = exports.getAllBooks = void 0;
...
function getBookById(request, response, id) {
    return __awaiter(this, void 0, void 0, function () {
        var book, array, error_2, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
...
// Method : GET function to get books by Author
function getBookByTitle(request, response, title) {
    return __awaiter(this, void 0, void 0, function () {
        var books, error_6;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, bookSchema_1.model.find({ 'title': title })];
                case 1:
                    books = _a.sent();
                    response.send(books);
                    return [3 /*break*/, 3];
...
function updateBook(request, response, id) {
    return __awaiter(this, void 0, void 0, function () {
        var bookFnd, error_10, newBook, error_11;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 6, , 7]);
