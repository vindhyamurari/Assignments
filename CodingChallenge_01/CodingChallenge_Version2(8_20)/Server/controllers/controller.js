...
exports.getMovieInfo = exports.addNewMovie = exports.deleteOneMovie = exports.getDirectorInfo = exports.updateDirectorDetails = exports.addNewDirector = void 0;
...
function updateDirectorDetails(request, response, name) {
    return __awaiter(this, void 0, void 0, function () {
        var director, newDetails, err_3, err_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 8, , 9]);
...
function getDirectorInfo(request, response, name) {
    return __awaiter(this, void 0, void 0, function () {
        var director, allMoviesOfGivenDirector, allMoviesFromDB, each_Movies, _i, allMoviesFromDB_1, _a, _b, each_director, err_5, err_6;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 3:
                    ...
                    return [2 /*return*/, response.status(200).send({ success: true, message: 'Director details Updated', allMoviesOfGivenDirector: allMoviesOfGivenDirector })];
                case 4: return [2 /*return*/, response.status(404).send({ success: false, message: 'Director Not Found' })];
                case 5: return [3 /*break*/, 7];
                case 6:
                    err_5 = _c.sent();
...
function addNewMovie(request, response) {
    return __awaiter(this, void 0, void 0, function () {
        var movie, each_director, helper, allDirectorsfromDB, _i, _a, one_director, _b, allDirectorsfromDB_1, err_9, err_10, err_11;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
...
function getMovieInfo(request, response, name) {
    return __awaiter(this, void 0, void 0, function () {
        var movie, allDirectors, movieDirectors, _i, _a, M_director, _b, allDirectors_1, D_director, err_12, err_13;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    _c.trys.push([0, 8, , 9]);
